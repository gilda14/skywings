...
export default function NewLoginPage() {
    ...
    try {
      ...
      if (typeof detail === 'string') {
        ...
        setError('Insert your correct email and Password')
      }
    } finally {
      setSubmitting(false)
    }
...
return (
    <div className="min-h-screen flex">
      {/* Brand panel */}
      <div className="hidden md:flex w-1/2 bg-gradient-to-br from-primaryleft to-blue-900 text-white items-center justify-center p-8">
